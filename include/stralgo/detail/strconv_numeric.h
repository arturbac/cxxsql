...
//     if( std::is_constant_evaluated())
  ...
  //--------------------------------------------------------------------------------------------------------
  template<strconcept::integral auto value,
           integral_format_traits traits,
           strconcept::char_type char_type
           >
  consteval auto integral_to_string_() noexcept
    {
    constexpr auto est_info { estimate_integral_to_str_<traits>(value) };
    stralgo::basic_fixed_string<char_type, est_info.size()> result;
    integral_to_string_<traits>(est_info, result.data());
    return result;
    }
  //--------------------------------------------------------------------------------------------------------
